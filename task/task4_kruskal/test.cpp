...
typedef tuple<int, int, int> edge;      // v1, v2, weight
...
int main(void)
{
    ...
    E.push_back(make_tuple(1, 2, 3));       // v1 - v2 (3)
    E.push_back(make_tuple(1, 3, 4));       // v1 - v3 (4)
    E.push_back(make_tuple(1, 4, 6));       // v1 - v4 (6)
    E.push_back(make_tuple(1, 5, 5));       // v1 - v5 (5)
    E.push_back(make_tuple(2, 3, 2));       // v2 - v3 (2)
    E.push_back(make_tuple(4, 5, 1));       // v4 - v5 (1)
    E.push_back(make_tuple(2, 5, 3));       // v1 - v2 (3)
